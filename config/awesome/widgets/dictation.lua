...
function Dictate_begin()
  ...
  local script = [=[bash -c '
      ...
      # echo $$ >> "/home/freeo/workbench/awm_dict.log"
      # ps -x | rg -v $$ >>  "/home/freeo/workbench/awm_dict.log"
      DURR=$(ps -x | rg -v $$ | rg -v "/bin/zsh -c")
      # echo $DURR >> "/home/freeo/workbench/awm_dict.log"
      # echo $DURR | rg "nerd-dictation"
      echo $DURR | rg "python3 /home/freeo/nerd-dictation/nerd-dictation begin"
      ret=$?
      echo $? >> "/home/freeo/workbench/awm_dict.log"
      echo $ret
      if [ $ret -ne 0 ]; then
          echo "starting dict..." >> "/home/freeo/workbench/awm_dict.log"
          /home/freeo/nerd-dictation/nerd-dictation begin --pulse-device-name=alsa_input.usb-Focusrite_Scarlett_8i6_USB_F8V7G1C090917A-00.multichannel-input &
          echo "run in background" >> "/home/freeo/workbench/awm_dict.log"
          echo "dictation started"
      else
        echo "dictation already running!" >> "/home/freeo/workbench/awm_dict.log"
      fi
      exit 1
  ...
  ' & ]=]
      ...
      -- # echo $DURR | rg "nerd-dictation" >> "/home/freeo/workbench/awm_dict.log"
      -- ps -aux | grep python >> "/home/freeo/workbench/awm_dict.log"
...
function Dictate_end()
    local pid_or_error = awful.spawn.with_shell(
      "~/nerd-dictation/nerd-dictation end")
    return Handle_Error(pid_or_error)
end
