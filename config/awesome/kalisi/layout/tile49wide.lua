...
tile.wide = {}
tile.wide.name = "tilewide"
tile.wide.arrange = do_tile
tile.wide.skip_gap = tile.skip_gap
function tile.wide.mouse_resize_handler(c, corner, x, y)
...
tile.arrange = tile.wide.arrange
tile.mouse_resize_handler = tile.wide.mouse_resize_handler
tile.name = tile.wide.name
