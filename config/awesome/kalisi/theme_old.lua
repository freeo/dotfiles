---------------------------------------------
-- Freeo's theme based on xresources
---------------------------------------------
...
awful.util.spawn_with_shell( "echo 'durr: " .. gears.filesystem.get_themes_dir() .. "' >> ~/workbench/awesome.log") end,

awful.util.spawn_with_shell( "echo 'durr: " .. themes_path .. "' >> ~/workbench/awesome.log") end,

awful.util.spawn_with_shell( "echo 'durr: " .. theme .. "' >> ~/workbench/awesome.log") end,
...
-- theme.widget_micMuted = "./dogeFail.gif"
-- theme.widget_micUnmuted = "./dogeOk.jpg"
--
-- local widgets = {
