...
;;;; Colors
                ...
                ((bg         '("#FFFFFF" "color-255" "black"        ))
                 ...
                 (purple-dark     '("#8030a0" "color-91"  "purple"))
                 ...
                 (blue-sapphire     '("#08298c" "color-0"   "black"   ))
                 ...
                 (green-important   '("#AFD700" "color-160" "green"   ))
                 (green-neon        '("#D7FF00" "color-160" "green"   ))
...
;;;; face categories -- required for all themes
                 ...
                 (comments       (if doom-kalisi-light-brighter-comments pink purple-dark))
  ...
  ;;;; Base theme face overrides
   ...
   ;;;; Flycheck
                 ...
                 ;; XXX not working! inspect. Workaround: set color in config.el
   ...
   ;;;; whitespace <built-in>
                 ...
                 (+workspace-tab-selected-face :foreground "#005f00" :background "#AFD700" :weight 'semi-bold)

                 ;; (centaur-tabs-selected :foreground black :background green-important)
                 ;; (centaur-tabs-selected-modified :foreground green-neon :background green-important)

                 (centaur-tabs-active-bar-face :background "#ff0000")
                 (centaur-tabs-selected :foreground "#303030" :background "#ffffff")
                 (centaur-tabs-selected-modified :foreground "#7FAD00" :background "#ffffff")
                 (centaur-tabs-modified-marker-selected   :foreground "#AFD700" :background "#ffffff")
                 (centaur-tabs-modified-marker-unselected :foreground "#AFD700" :background "#cccccc")
                 (centaur-tabs-unselected   :foreground "#454545" :background "#cccccc")
                 (centaur-tabs-unselected-modified   :foreground "#009B7C" :background "#cccccc")

                 ;; not working... overridden somehow.
                 ;; (org-quote   :foreground "blue-sapphire" :background "grey" )


                 )
                ;; Plugin Support
                (
                 ;; not working... gets overwritten by the plugin. How to do actual plugin support like the mentioned plugins here at centaur-tabs repo?
